...
public class Manifestation {
	...
	public String toString() {
		return "[name=" + name + ", manifestationType=" + manifestationType + ", numberOfSeats="
				+ numberOfSeats + ", dateTime=" + dateTime + ", regularPrice=" + regularPrice + ", status=" + status
				+ ", location=" + location + ", eventPoster=" + eventPoster + "]";
	}
